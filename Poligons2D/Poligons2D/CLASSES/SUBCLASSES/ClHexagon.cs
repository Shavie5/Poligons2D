...
namespace Poligons2D.CLASSES.SUBCLASSES
{
    internal class ClHexagon : ClPoligons
    {
        ...
        public ClHexagon(ClBd xbd, String xNom, int xCostat, String xColor, int xTeInterior, String xGrup) : base(xbd, xNom, xColor, xTeInterior, xGrup)
        {
            String xsql = $"INSERT INTO Hexagon (Nom, Costat) VALUES('{xNom}', {xCostat})";
        ...
        {
            return (3 * Math.Sqrt(3) / 2) * Mida * Mida;
        }
